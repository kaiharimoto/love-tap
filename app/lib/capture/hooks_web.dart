...
extension type _Win(JSObject o) implements JSObject {
  ...
  external set __deskCut(JSFunction f);
  ...
  external set __deskCompose(JSFunction f);
...
void expose(CaptureHooks hooks) {
  ...
  w.__deskCut = ((JSBoolean cut) => _said(Future.value(hooks.cutTheLink(cut.toDart)))).toJS;
  ...
  w.__deskCompose = ((JSString text) => hooks.compose(text.toDart).toJS).toJS;
