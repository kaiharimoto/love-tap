          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: [
                ...
                _Chip(
                  label: range == null ? 'all year' : '${DateFormat('d MMM').format(range!.start)}–${DateFormat('d MMM').format(range!.end)}',
                  on: range != null,
                  onTap: () => onRange(range == null
                            ...
                            for (final f in registry.active)
                              GestureDetector(
                                ...
                                child: Column(children: [
                                  ...
                                  Text(f.name, style: Hands.margin(size: 10), maxLines: 1, overflow: TextOverflow.ellipsis),
                                ]),
                              ),
                          ],
                        ),
        ...
        return Padding(
          ...
          child: Row(
            ...
            children: [
              SizedBox(
                width: 86,
                child: Text(DateFormat('d MMM yy').format(DateTime.fromMillisecondsSinceEpoch(e.ts)),
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(DateFormat('EEE d MMM · HH:mm').format(DateTime.fromMillisecondsSinceEpoch(e.ts)),
