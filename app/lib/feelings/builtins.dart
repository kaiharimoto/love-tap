...
const List<Feeling> kBuiltInFeelings = [
  ...
  Feeling(id: 'thinking_of_you', name: 'thinking of you', family: Family.warmth, object: 'obj_bookmark', haptic: '40@80 off300 40@80 off300 260@170', sound: 'snd_thinking', colour: '#1f2a44'),
  Feeling(id: 'goodnight', name: 'goodnight', family: Family.warmth, object: 'obj_dog_ear', haptic: '500@120 off200 250@80 off200 120@50', sound: 'snd_goodnight', colour: '#2c3555'),
  ...
  Feeling(id: 'breathe', name: 'breathe', family: Family.shelter, object: 'obj_blanket_fold', haptic: '1200@110 off800 500@110', sound: 'snd_breathe', colour: '#4a4a4c'),
  ...
  Feeling(id: 'nyeh', name: 'nyeh', family: Family.mischief, object: 'obj_wrapper', haptic: '30@200 off50 30@200 off50 90@255', sound: 'snd_nyeh', colour: '#a8322b'),
  ...
  Feeling(id: 'stuck_with_me', name: 'stuck with me', family: Family.mischief, object: 'obj_staple_chain', haptic: '40@200 off60 40@200 off60 1200@150', sound: 'snd_stuck', colour: '#7a7a7e'),
  Feeling(id: 'overwhelmed', name: 'overwhelmed', family: Family.static_, object: 'obj_crumple_ball', haptic: '(18@255 off14) ×14', sound: 'snd_overwhelmed', colour: '#141a2e'),
  ...
  Feeling(id: 'grey', name: 'grey', family: Family.static_, object: 'obj_pencil_smudge', haptic: '(60@70 off60) ×8', sound: 'snd_grey', colour: '#8a8a8e'),
  ...
  Feeling(id: 'did_it', name: 'did it', family: Family.sparkle, object: 'obj_cork', haptic: '40@120 off60 40@170 off60 40@220 off60 200@255', sound: 'snd_didit', colour: '#c9a23a'),
  Feeling(id: 'confetti', name: 'confetti', family: Family.sparkle, object: 'obj_confetti', haptic: '20@140 off90 20@200 off40 20@120 off150 20@230 off60 20@160', sound: 'snd_confetti', colour: '#f2a8c0'),
  Feeling(id: 'yes', name: 'yes', family: Family.sparkle, object: 'obj_bunting', haptic: '60@100 off40 60@180 off40 60@255 off200 60@255 off40 60@255', sound: 'snd_yes', colour: '#a8322b'),
  Feeling(id: 'crown', name: 'paper hat', family: Family.sparkle, object: 'obj_party_hat', haptic: '100@120 off100 100@170 off100 100@220 off100 100@255 off300 300@255', sound: 'snd_crown', colour: '#f4ea6a'),
